        ...
        <div className="row">
          <div className="col-md-12 text-center">
            <h2 className="sec-title">
              <span>Apprentissage en ligne</span> Offre 3 types de forfaits d’adhésion
            </h2>
          </div>
        </div>
        <div className="row justify-content-center">
          <div className="col-md-12">
            <div id="card-slider" className="pack-slid">
              <PackageCard
                packageInfo={{
                  img: "assets/images/home/p2.png",
                  statusImg: "assets/images/home/gold.png",
                  price: "750",
                  offerPrice: "450",
                  memberShipStatus: "Adhésion Or",
                  lessons: "12",
                  classes: "3",
                  link: "/single-course",
                  description:
              ...
              <PackageCard
                packageInfo={{
                  img: "assets/images/home/p3.png",
                  statusImg: "assets/images/home/silver.png",
                  price: "750",
                  offerPrice: "450",
                  memberShipStatus: "Adhésion Argent",
                  lessons: "12",
                  classes: "3",
                  link: "/single-course",
                  description:
              ...
              <PackageCard
                packageInfo={{
                  ...
                  price: "750",
                  offerPrice: "450",
                  memberShipStatus: "Adhésion Bronze",
                  lessons: "12",
                  classes: "3",
                  link: "/single-course",
                  description:
