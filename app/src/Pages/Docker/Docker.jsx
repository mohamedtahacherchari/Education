  ...
  if (isLoading) {
    ...
    content = (
      <>
        ...
        <Banner title="Docker" background="assets/images/banner7.png" />
              ...
              <div className="col-lg-9">
                <div className="single-course-area">
                  <div className="course-top">
                    ...
                    <h4>DOCKER - Initiation & avancé</h4>
                    <p>
                  ...
                  <div className="sc-thumb">
                    <img src="assets/images/single-course/3.jpg" alt="" />
                  </div>
                      ...
                      {activeView === "Aperçu" && (
                        ...
                        >
                          <div className="overview-content">
                            ...
                            <p>
							Plongez dans l'univers de Docker, l'outil DevOps incontournable.
Notre formation intensive vous guidera à travers les fondamentaux et les subtilités de Docker, révolutionnant ainsi la gestion des conteneurs et l'orchestration d'applications.
Explorez les avantages de l'isolation, de la portabilité et de la scalabilité offerts par Docker.
Soyez prêt à maîtriser cet outil puissant et à libérer tout son potentiel pour vos déploiements d'applications modernes.
                            </p>
                            <p>
...
Dominez les aspects avancés de Docker, des conteneurs aux orchestrations,
 afin d'optimiser le déploiement et la gestion de vos applications. Explorez les pratiques collaboratives avec les fonctionnalités les plus récentes, propulsant ainsi votre expertise
 dans le domaine du déploiement et de la gestion d'environnements logiciels.
                                </span>
                              </li>
                              <li>
                                <i className="icon_check_alt2"></i>
                                ...
                                <span>
								Obtenez une certification officielle en maîtrisant Docker, renforçant ainsi vos compétences 
								en déploiement et gestion d'applications conteneurisées. Recevez un diplôme attestant de votre expertise dans l'utilisation avancée de Docker, ouvrant la voie à une carrière florissante 
								dans le domaine du déploiement logiciel et de la gestion d'environnements virtualisés.                  
                                </span>
                              </li>
                              <li>
                                <i className="icon_check_alt2"></i>
                            ...
                            >
                              <div className="card-body">
                                ...
                                <div className="ci-item with-bg">
                                  <h5>
                                    <i className="icon_menu-square_alt2"></i>
                                    <Link to="/">Installation et configuration (explication des étapes)</Link>
                                  </h5>
                                  <div className="ci-tools">
                                    <Link to="/" className="time">
                                    Jour 1
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Les TPs se feront sur des machines avec Docker pré-installé
								<div className="ci-item with-bg">
                                  <h5>
                                    <i className="icon_menu-square_alt2"></i>
                                    <Link to="/">  La programmation Orientée Objet</Link>
                                  </h5>
                                  <div className="ci-tools">
                                    <Link to="/" className="time">
                                    Jour 1
								...
								<div className="ci-item with-bg">
                                  <h5>
                                    <i className="icon_menu-square_alt2"></i>
                                    <Link to="/"> Commandes de base</Link>
                                  </h5>
                                  <div className="ci-tools">
                                    <Link to="/" className="time">
                                    Jour 1
								...
								<div className="ci-item with-bg">
                                  <h5>
                                    <i className="icon_menu-square_alt2"></i>
                                    <Link to="/">Comprendre un Dockerfile</Link>
                                  </h5>
                                  <div className="ci-tools">
                                    <Link to="/" className="time">
                                    Jour 1
								...
								<div className="ci-item with-bg">
                                  <h5>
                                    <i className="icon_menu-square_alt2"></i>
                                    <Link to="/">Conteneur vs Image</Link>
                                  </h5>
                                  <div className="ci-tools">
                                    <Link to="/" className="time">
                                    Jour 1
                            ...
                            <div className="card-header" id="cc_2">
                              <h5 className="mb-0">
                                <button
                                  ...
                                  aria-controls="acc_2"
                                >
                Déployer vos applications avec Docker (Docker Avancé)
                                </button>
                              </h5>
                            </div>
                            <div
                            ...
                            >
                              <div className="card-body">
                                <div className="ci-item with-bg">
                                  <h5>
                                    <i className="icon_menu-square_alt2"></i>
                                    <Link href="#">Commandes Avancées Docker</Link>
                                  </h5>
                                  <div className="ci-tools">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Travaux Pratiques
                            ...
                            <div className="card-header" id="cc_3">
                              <h5 className="mb-0">
                                <button
                                  ...
                                  aria-controls="acc_3"
                                >
                Travaux pratiques (Docker Avancé)
                                </button>
                              </h5>
                            </div>
                            <div
            ...
            <div className="ci-item">
                                  <h5>
                                    <i className="icon_menu-square_alt2"></i>
                                    <Link to="/">
									Persistence de données avec Docker
                                    </Link>
                                  </h5>
                                  <div className="ci-tools">
                                    <Link to="/" className="time">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Travaux Pratiques
						<div className="ci-item with-bg">
                                  <h5>
                                    <i className="icon_menu-square_alt2"></i>
                                    <Link to="/"> Orchestrateur de conteneurisation</Link>
                                  </h5>
                                  <div className="ci-tools">
