  ...
  if (isLoading) {
    ...
    content = (
      <>
        ...
        <Banner title="Python" background="assets/images/banner10.png" />
              ...
              <div className="col-lg-9">
                <div className="single-course-area">
                  <div className="course-top">
                    ...
                    <h4>Python - Initiation & avancé</h4>
                    <p>
					Découvrez les bases de la programmation en utilisant le langage Python.
                    </p>
                  ...
                  <div className="sc-thumb">
                    <img src="assets/images/single-course/6.png" alt="" />
                  </div>
...
Dominez les aspects avancés de Python, des concepts fondamentaux à la programmation avancée, 
afin d'optimiser le développement et la gestion de vos applications. Explorez les pratiques 
collaboratives avec les fonctionnalités les plus récentes, propulsant ainsi votre expertise
                            ...
                            <div className="card-header" id="cc_1">
                              <h5 className="mb-0">
                                <button
                                  ...
                                  aria-controls="acc_1"
                                >
                        Présebtation du langage et de ses usages 
                                </button>
                              </h5>
                            </div>
                              ...
                              <div className="card-body">
                                <div className="ci-item with-bg">
                                  <h5>
                                    ...
                                    <Link href="#">Installation de Jenkins</Link>
                                  </h5>
                            ...
                            >
                              <div className="card-body">
                                <div className="ci-item with-bg">
                                  <h5>
                                    <i className="icon_menu-square_alt2"></i>
                                    <Link to="/"> Les interfaces graphique avec Tkinter
</Link>
                                  </h5>
                                  <div className="ci-tools">
                                    <Link to="/" className="time">
                            ...
                            <div className="card-header" id="cc_3">
                              <h5 className="mb-0">
                                <button
                                  ...
                                  aria-controls="acc_3"
                                >
        Python et ses usages scientifiques
                                </button>
                              </h5>
                            </div>
                            <div
